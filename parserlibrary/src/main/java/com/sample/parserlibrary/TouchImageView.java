package com.sample.parserlibrary; //STTutorialPreviewImageView
...
public class TouchImageView extends android.support.v7.widget.AppCompatImageView {
    ...
    public RectF getZoomedRect() {
        ...
        RectF retRectF = new RectF(topLeft.x / w, topLeft.y / h
    ...
    private void translateMatrixAfterRotate(int axis, float trans, float prevImageSize,
                                            float imageSize, int prevViewSize,
        ...
        if (imageSize < viewSize) {
            ...
            // Determine its distance from the left/top side of the view as a fraction
            // of the entire image's width/height. Use that percentage
